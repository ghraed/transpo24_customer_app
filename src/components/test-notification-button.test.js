...
import { registerCustomerPushNotifications as register } from '@/notifications/registerPushNotifications';

jest.mock('@/lib/api', () => ({ sendTestNotification: jest.fn() }));
jest.mock('@/notifications/registerPushNotifications', () => ({ registerCustomerPushNotifications: jest.fn() }));
